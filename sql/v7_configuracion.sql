...
--   mora_porcentaje_mensual: % mensual de mora sobre saldo vencido por período
...
values
  ...
  ('mora_porcentaje_mensual', 0, 'Porcentaje mensual de mora sobre saldo vencido por período')
